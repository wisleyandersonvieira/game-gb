...
- **B — Tablet** (grande), dividida em duas entregas.
  ...
  - [x] **Desempenho (25/09/2026)** — o gestor relatou lentidão ao trocar de tela. Medido antes de mexer.
    ...
    - **Critério daqui para frente: toda tela abre em menos de 1,5 s.** A tela `/medir` mede; o script `supabase/medir-o-banco.sql` mede o banco. A medição fica **desligada por padrão** e `/medir` é **só do master**.
