...
- [x] **A — Acesso (23/09/2026)** — banco, servidor e telas, com teste de isolamento:
  ...
  - [ ] **Conferir no Supabase (Authentication → URL Configuration):** `Site URL` = `https://stgame.lovable.app` e `Redirect URLs` com `https://stgame.lovable.app/**`. Sem isso, o link de recuperação e o convite de clientes não abrem (foi o que aconteceu em 24/09/2026). O Secret `SITE_URL` precisa do mesmo endereço.
