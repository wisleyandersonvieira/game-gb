...
- [ ] **C — Celular** (médio): minhas tarefas, entrega com foto, saldo, extrato, conquistas, nota, ranking com "Nome I.", pedido de resgate, comunicados, documentos, canal confidencial, perfil.
  ...
  - [x] **A TV virou configurável por loja, com visual novo (25/09/2026)**
    ...
    - **O piso de 24 px mudou de forma.** O layout aprovado usa rótulos pequenos, que são etiqueta e não texto de leitura. O teste passou a cobrar **por papel**: nome da tarefa e do pódio ≥ 26 px, linha secundária ≥ 20 px, loja ≥ 60 px, e nada na tela abaixo de 15 px. Está anotado aqui porque **relaxa uma regra que já tinha sido aprovada** — se preferir tudo em 24 px, é uma linha.
