...
- [x] **A — Acesso (23/09/2026)** — banco, servidor e telas, com teste de isolamento:
  ...
  - [ ] **Melhoria futura (Etapa 1.14):** trocar "bloquear no 5º erro" por **atraso progressivo** (1 s, 2 s, 4 s… até 30 s) na trava por chave, mantendo bloqueio duro só por origem. Acaba com o estado "trancado" e, com ele, com a janela de 15 minutos que um terceiro ainda consegue causar no login do gestor e do colaborador.
...
- **B — Tablet** (grande), dividida em duas entregas.
  ...
  - [ ] **Decisão sua, em aberto:** a tela **Ranking** recalcula qualquer mês ao vivo, então meses antigos em que alguém pegou missão passam a mostrar outros números (a regra "quem pega assume" vale para trás). Os meses **fechados** não mudam: ficam congelados em `historicoranking`, que é o que a tela "Meses fechados" mostra. Ou aceitamos a diferença, ou faço a tela Ranking ler o fechamento quando o mês já tem um. Como ainda não há dados de verdade, o impacto hoje é zero.
